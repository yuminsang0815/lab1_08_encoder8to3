...
HD_PWD='C:/Users/a2391/lab1_08_encoder8to3/encoder8x3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder8x3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder8x3.tcl -notrace
